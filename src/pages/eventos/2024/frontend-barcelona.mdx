...
<table class="w-full">
  <tr class="list-group-item d-flex flex-column flex-sm-row align-items-center justify-content-between p-4">
    <td class="d-flex align-items-center">
      ...
      <h4 class="fs-base fw-semibold text-nowrap ps-1 mb-0">Blind</h4>
    </td>
    <td><h5 class="badge text-primary fs-5 fw-bold rounded my-3 my-sm-0">199€</h5></td>
  ...
  <tr class="list-group-item d-flex flex-column flex-sm-row align-items-center justify-content-between p-4">
    <td class="d-flex align-items-center">
      ...
      <h4 class="fs-base fw-semibold text-nowrap ps-1 mb-0">Early</h4>
    </td>
    <td><h5 class="text-primary my-2 my-sm-0">249€</h5></td>
  ...
  <tr class="list-group-item d-flex flex-column flex-sm-row align-items-center justify-content-between p-4">
    <td class="d-flex align-items-center">
      ...
      <h4 class="fs-base fw-semibold text-nowrap ps-1 mb-0">Regular</h4>
    </td>
    <td><h5 class="text-primary my-2 my-sm-0">299€</h5></td>
  ...
  <tr class="list-group-item d-flex flex-column flex-sm-row align-items-center justify-content-between p-4">
    <td class="d-flex align-items-center">
      ...
      <h4 class="fs-base fw-semibold text-nowrap ps-1 mb-0">Late</h4>
    </td>
    <td><h5 class="text-primary my-2 my-sm-0">349€</h5></td>
