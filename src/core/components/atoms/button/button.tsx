...
const BUTTON_DEFAULT_CLASSES =
  "inline-flex items-center justify-center w-full px-8 py-4 font-bold leading-6 text-white bg-primary dark:bg-accent border border-transparent rounded-full md:w-auto hover:bg-primary-light dark:hover:bg-accent-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600";
