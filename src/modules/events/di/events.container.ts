...
import { SendOrganizationEventUpdatedEmailCommand } from '@/emails/application/send-organization-event-updated-email.command'
...
builder
  ...
  .useFactory(_ => EmailsContainer.get(SendOrganizationEventUpdatedEmailCommand))
