...
import { buttonVariants } from '@/modules/shared/presentation/ui/button'
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_range_start: 'day-range-start aria-selected:bg-primary-strong aria-selected:text-primary-foreground',
        day_range_end: 'day-range-end aria-selected:bg-primary-strong aria-selected:text-primary-foreground',
        day_selected:
      ...
      components={{
        IconLeft: ({ className, ...props }) => <CaretLeft className={cn('size-4', className)} {...props} />,
        IconRight: ({ className, ...props }) => <CaretRight className={cn('size-4', className)} {...props} />,
      }}
      locale={es}
      {...props}
    />
