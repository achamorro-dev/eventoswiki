        ...
        <div className="space-y-6 py-4">
          <div className="flex w-full flex-col items-start gap-4 lg:flex-row">
            ...
            <div className="w-full flex-1 space-y-6">
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <>
                            ...
                            {field.value && (
                              <PlaceEmbedMap place={field.value as Primitives<Place> | undefined} height="200px" />
                            )}
                          </>
                        )}
                      />
              ...
              <div className="border-t pt-6">
                <h2 className="mb-4 font-semibold text-xl">Configuración de asistentes</h2>
                <div className="space-y-4">
                  <FormField
                    control={form.control}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <p className="mb-2 text-muted-foreground text-sm">Número máximo de asistentes permitidos</p>
                            <FormControl>
                              <Input
                                id="maxAttendees"
                                type="number"
